...
#      offline in seeded test mode (RefugeRestroomsSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "RefugeRestrooms_sdk.rb")
  SDK_CLASS = "RefugeRestroomsSDK"
