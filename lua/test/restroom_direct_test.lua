...
describe("RestroomDirect", function()
  it("should direct-list-restroom", function()
    local setup = restroom_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-restroom", setup.live and "live" or "unit")
...
function restroom_direct_setup(mockres)
