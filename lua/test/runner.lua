...
function runner.env_override(m)
  local live = runner.getenv("REFUGE_RESTROOMS_TEST_LIVE")
  local override = runner.getenv("REFUGE_RESTROOMS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("REFUGE_RESTROOMS_TEST_EXPLAIN")
