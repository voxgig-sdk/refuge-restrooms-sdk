# RefugeRestrooms TypeScript SDK



The TypeScript SDK for the RefugeRestrooms API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Restroom()` — each with a small set of operations (`list`)
...
```ts
new RefugeRestroomsSDK(options?: {
  base?: string
  prefix?: string
  suffix?: string
...
| `tester(testopts?, sdkopts?)` | `RefugeRestroomsSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `RefugeRestroomsSDK.test(testopts?, sdkopts?)` | `RefugeRestroomsSDK` | Create a test-mode client. |
...
| `client` | `client(): RefugeRestroomsSDK` | Return the parent SDK client. |
...
refuge-restrooms/
├── src/
│   ├── RefugeRestroomsSDK.ts        # Main SDK class
