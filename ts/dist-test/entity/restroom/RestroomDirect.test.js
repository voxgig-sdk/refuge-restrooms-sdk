...
(0, node_test_1.describe)('RestroomDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.RefugeRestroomsSDK({
    ...
    (0, node_test_1.test)('direct-list-restroom', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-restroom', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.REFUGE_RESTROOMS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.RefugeRestroomsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['REFUGE_RESTROOMS_TEST_RESTROOM_ENTID'];
    ...
    const client = new __1.RefugeRestroomsSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=RestroomDirect.test.js.map