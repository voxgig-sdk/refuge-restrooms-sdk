...
function envOverride(m) {
    if ('TRUE' === process.env.REFUGE_RESTROOMS_TEST_LIVE ||
        'TRUE' === process.env.REFUGE_RESTROOMS_TEST_OVERRIDE) {
    ...
    m.REFUGE_RESTROOMS_TEST_EXPLAIN = process.env.REFUGE_RESTROOMS_TEST_EXPLAIN || m.REFUGE_RESTROOMS_TEST_EXPLAIN;
    return m;
}
