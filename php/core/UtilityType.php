...
// RefugeRestrooms SDK utility type

class RefugeRestroomsUtility
{
    ...
    public static function copy(RefugeRestroomsUtility $src): RefugeRestroomsUtility
    {
        $u = new RefugeRestroomsUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
