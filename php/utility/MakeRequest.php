...
// RefugeRestrooms SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class RefugeRestroomsMakeRequest
{
    public static function call(RefugeRestroomsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new RefugeRestroomsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new RefugeRestroomsResponse($fetched);
        } else {
