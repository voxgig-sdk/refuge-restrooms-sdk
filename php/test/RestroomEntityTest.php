...
class RestroomEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = RefugeRestroomsSDK::test($seed, null);
        $seen = iterator_to_array($base->Restroom(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->Restroom(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set REFUGE_RESTROOMS_TEST_RESTROOM_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function restroom_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("REFUGE_RESTROOMS_TEST_RESTROOM_ENTID");
