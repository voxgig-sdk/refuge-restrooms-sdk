...
// RefugeRestrooms SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RefugeRestroomsSDK::test)
...
{
    private const SDK_CLASS = 'RefugeRestroomsSDK';
    ...
    private const SDK_BASE = 'refugerestrooms_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../refugerestrooms_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
