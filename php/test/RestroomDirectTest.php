...
class RestroomDirectTest extends TestCase
{
    public function test_direct_list_restroom(): void
    {
        $setup = restroom_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-restroom", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
