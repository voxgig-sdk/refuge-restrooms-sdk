...
// RefugeRestrooms SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = RefugeRestroomsOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(RefugeRestroomsOmni::structfix($now, Struct::undef()))
                        !== json_encode(RefugeRestroomsOmni::structfix($val, Struct::undef()))) {
