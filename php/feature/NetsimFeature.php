...
// RefugeRestrooms SDK netsim feature
...
class RefugeRestroomsNetsimFeature extends RefugeRestroomsBaseFeature
{
    ...
    private function _simulate(RefugeRestroomsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RefugeRestroomsContext $ctx, array $applied): void
    {
        $client = $this->client;
