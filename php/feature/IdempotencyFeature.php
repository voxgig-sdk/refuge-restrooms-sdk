...
// RefugeRestrooms SDK idempotency feature
...
class RefugeRestroomsIdempotencyFeature extends RefugeRestroomsBaseFeature
{
    ...
    private function _mutating(RefugeRestroomsContext $ctx): bool
    {
