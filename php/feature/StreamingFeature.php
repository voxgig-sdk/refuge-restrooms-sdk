...
// RefugeRestrooms SDK streaming feature
...
class RefugeRestroomsStreamingFeature extends RefugeRestroomsBaseFeature
{
    ...
    private function _iterate(RefugeRestroomsResult $result): \Generator
    {
    ...
    private function _streamable(RefugeRestroomsContext $ctx): bool
    {
