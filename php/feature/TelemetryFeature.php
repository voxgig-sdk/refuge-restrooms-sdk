...
// RefugeRestrooms SDK telemetry feature
...
class RefugeRestroomsTelemetryFeature extends RefugeRestroomsBaseFeature
{
    ...
    private function _close(RefugeRestroomsContext $ctx, bool $ok): void
    {
