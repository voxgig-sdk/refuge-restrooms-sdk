...
// RefugeRestrooms SDK audit feature
...
class RefugeRestroomsAuditFeature extends RefugeRestroomsBaseFeature
{
    ...
    private function _emit(RefugeRestroomsContext $ctx, string $outcome): void
    {
