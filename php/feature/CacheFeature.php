...
// RefugeRestrooms SDK cache feature
...
class RefugeRestroomsCacheFeature extends RefugeRestroomsBaseFeature
{
    ...
    private function _through(RefugeRestroomsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
