...
class RefugeRestroomsSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = RefugeRestroomsHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = RefugeRestroomsHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!RefugeRestroomsFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, RefugeRestroomsFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return RefugeRestroomsUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = RefugeRestroomsHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = RefugeRestroomsHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = RefugeRestroomsHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new RefugeRestroomsError($op . "_allow",
                "RefugeRestroomsSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = RefugeRestroomsHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new RefugeRestroomsError("graphql_error",
                "RefugeRestroomsSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Restroom($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_restroom === null) {
                $this->_restroom = new RestroomEntity($this, null);
            }
            return $this->_restroom;
        }
        return new RestroomEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new RefugeRestroomsSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
