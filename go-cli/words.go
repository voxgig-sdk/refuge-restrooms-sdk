...
func registerSDKWords(r *eng.Registry, client *sdk.RefugeRestroomsSDK) {
...
func runOp(client *sdk.RefugeRestroomsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
