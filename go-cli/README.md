...
AQL-driven CLI and REPL for the RefugeRestrooms SDK. Positional arguments are
...
```sh
go build -o refuge-restrooms-cli ./...
```
...
./refuge-restrooms-cli load 1 restroom
./refuge-restrooms-cli load '{id:1}' restroom
