...
type Args struct {
	Entity string         `json:"entity" jsonschema:"restroom"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.RefugeRestroomsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "refuge-restrooms_list",
		Description: "List records from RefugeRestrooms. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "refuge-restrooms_load",
		Description: "Load a single record from RefugeRestrooms. " +
...
func runOp(client *sdk.RefugeRestroomsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.RefugeRestroomsSDK, name string) (sdk.RefugeRestroomsEntity, error) {
	switch strings.ToLower(name) {
	case "restroom":
		return client.Restroom(nil), nil
