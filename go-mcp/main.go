// Command RefugeRestrooms-mcp is an MCP server exposing the RefugeRestrooms
// SDK as MCP tools.
//
// Two tools are registered:
//
//	RefugeRestrooms_list  — list records of an entity
//	RefugeRestrooms_load  — load a single record of an entity
//
