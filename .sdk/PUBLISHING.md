...
|---|---|---|
| `ts/` | @voxgig-sdk/refuge-restrooms-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/refuge-restrooms-sdk \
      --repository voxgig-sdk/refuge-restrooms-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/refuge-restrooms-sdk` shows it, and
`npm trust revoke @voxgig-sdk/refuge-restrooms-sdk --id=<id>` removes it.
