...
// RefugeRestrooms SDK utility: graphql
//
...
class RefugeRestroomsGraphql
{
    ...
    // equivalent.
    public static function body(RefugeRestroomsContext $ctx): mixed
    {
    ...
    public static function errors(RefugeRestroomsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
