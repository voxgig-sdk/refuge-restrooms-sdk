...
// RefugeRestrooms SDK utility: make_options

class RefugeRestroomsMakeOptions
{
    ...
    public static function call(RefugeRestroomsContext $ctx): array
    {
        ...
        //
        // `RefugeRestroomsSchema::optspec()` is built from the model:
        ...
        $optspec = RefugeRestroomsSchema::optspec();
