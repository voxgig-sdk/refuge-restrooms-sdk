...
// RefugeRestrooms SDK utility: fetcher

class RefugeRestroomsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; RefugeRestroomsSDK/1.0)';
    ...
    public static function call(RefugeRestroomsContext $ctx, string $fullurl, array $fetchdef): array
    {
