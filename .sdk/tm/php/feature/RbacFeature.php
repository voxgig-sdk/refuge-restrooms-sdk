...
// RefugeRestrooms SDK rbac feature
...
class RefugeRestroomsRbacFeature extends RefugeRestroomsBaseFeature
{
    ...
    private function _required(RefugeRestroomsContext $ctx): ?string
    {
    ...
    private function _reject(RefugeRestroomsContext $ctx, string $required): void
    {
    ...
    private function _track(RefugeRestroomsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
