...
// RefugeRestrooms SDK timeout feature
...
class RefugeRestroomsTimeoutFeature extends RefugeRestroomsBaseFeature
{
    ...
    private function _with_timeout(RefugeRestroomsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RefugeRestroomsContext $_ctx, float $ms): void
    {
        $client = $this->client;
