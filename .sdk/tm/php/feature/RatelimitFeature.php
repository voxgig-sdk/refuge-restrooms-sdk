...
// RefugeRestrooms SDK ratelimit feature
...
class RefugeRestroomsRatelimitFeature extends RefugeRestroomsBaseFeature
{
    ...
    private function _acquire(RefugeRestroomsContext $ctx): void
    {
    ...
    private function _track(RefugeRestroomsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
