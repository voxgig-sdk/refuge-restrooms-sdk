...
// RefugeRestrooms SDK proxy feature
...
class RefugeRestroomsProxyFeature extends RefugeRestroomsBaseFeature
{
    ...
    public function init(RefugeRestroomsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RefugeRestroomsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
