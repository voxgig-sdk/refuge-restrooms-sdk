...
// RefugeRestrooms SDK clienttrack feature
...
class RefugeRestroomsClienttrackFeature extends RefugeRestroomsBaseFeature
{
    ...
    public function PostConstruct(RefugeRestroomsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'RefugeRestrooms-SDK';
