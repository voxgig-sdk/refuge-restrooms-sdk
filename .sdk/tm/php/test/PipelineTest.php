...
// RefugeRestrooms SDK pipeline test
//
...
{
    private static function utility(): RefugeRestroomsUtility
    {
        return new RefugeRestroomsUtility();
    }
    ...
    private static function ctx(array $over = []): RefugeRestroomsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new RefugeRestroomsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new RefugeRestroomsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof RefugeRestroomsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new RefugeRestroomsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = RefugeRestroomsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new RefugeRestroomsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = RefugeRestroomsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new RefugeRestroomsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = RefugeRestroomsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RefugeRestroomsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = RefugeRestroomsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new RefugeRestroomsResponse([]),
            'result' => new RefugeRestroomsResult([]),
        ]);
        [, $err] = RefugeRestroomsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new RefugeRestroomsSpec([]),
            'response' => null,
            'result' => new RefugeRestroomsResult([]),
        ]);
        [, $err] = RefugeRestroomsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new RefugeRestroomsSpec(['step' => 's']),
            'response' => new RefugeRestroomsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new RefugeRestroomsResult([]),
        ]);
        [, $err] = RefugeRestroomsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new RefugeRestroomsSpec(['step' => 's']),
            'response' => new RefugeRestroomsResponse(self::resp(200, ['v' => 1])),
            'result' => new RefugeRestroomsResult([]),
        ]);
        [, $err] = RefugeRestroomsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new RefugeRestroomsSpec(['step' => 's']),
            'response' => new RefugeRestroomsResponse(self::resp(200, ['v' => 2])),
            'result' => new RefugeRestroomsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        RefugeRestroomsMakeResponse::call($ctx);
    ...
    {
        $preset = new RefugeRestroomsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new RefugeRestroomsSpec([]),
            'response' => new RefugeRestroomsResponse([]),
            'result' => new RefugeRestroomsResult([]),
        ...
        [$got, $err] = RefugeRestroomsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new RefugeRestroomsResult([])]);
        [, $err] = RefugeRestroomsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new RefugeRestroomsSpec([]), 'result' => null]);
        [, $err] = RefugeRestroomsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RefugeRestroomsSpec(['step' => 's']),
            'result' => new RefugeRestroomsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new RefugeRestroomsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RefugeRestroomsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RefugeRestroomsSpec(['step' => 's']),
            'result' => new RefugeRestroomsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new RefugeRestroomsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RefugeRestroomsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RefugeRestroomsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new RefugeRestroomsSpec([]),
            'result' => new RefugeRestroomsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = RefugeRestroomsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RefugeRestroomsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new RefugeRestroomsError('boom', 'boom');
        $utility->fetcher = function (RefugeRestroomsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RefugeRestroomsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = RefugeRestroomsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (RefugeRestroomsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = RefugeRestroomsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(RefugeRestroomsResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        RefugeRestroomsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (RefugeRestroomsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RefugeRestroomsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = RefugeRestroomsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new RefugeRestroomsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new RefugeRestroomsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = RefugeRestroomsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = RefugeRestroomsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = RefugeRestroomsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new RefugeRestroomsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, RefugeRestroomsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new RefugeRestroomsResult(['ok' => false])]);
        $this->expectException(RefugeRestroomsError::class);
        RefugeRestroomsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new RefugeRestroomsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', RefugeRestroomsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        RefugeRestroomsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new RefugeRestroomsBaseFeature();
        $b = new RefugeRestroomsBaseFeature();
        RefugeRestroomsFeatureAdd::call($ctx, $a);
        RefugeRestroomsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): RefugeRestroomsBaseFeature
    {
        $f = new RefugeRestroomsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        RefugeRestroomsFeatureAdd::call($ctx, self::named_feature('a'));
        RefugeRestroomsFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        RefugeRestroomsFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        RefugeRestroomsFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        RefugeRestroomsFeatureAdd::call($ctx, $replace);
        ...
        RefugeRestroomsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): RefugeRestroomsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new RefugeRestroomsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RefugeRestroomsPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        RefugeRestroomsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new RefugeRestroomsResponse(['headers' => null]),
            'result' => new RefugeRestroomsResult([]),
        ]);
        RefugeRestroomsResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        RefugeRestroomsResultBody::call($ctx);
