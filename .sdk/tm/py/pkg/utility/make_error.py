...
def make_error_util(ctx, err):
    if ctx is None:
        from projectname_sdk.core.context import RefugeRestroomsContext
        ctx = RefugeRestroomsContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, RefugeRestroomsError):
        errmsg = err.msg
    ...
    sdk_err = RefugeRestroomsError("", msg, ctx)
