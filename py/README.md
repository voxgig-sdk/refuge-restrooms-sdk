# RefugeRestrooms Python SDK



The Python SDK for the RefugeRestrooms API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Restroom()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/refuge-restrooms-sdk/releases)) or
...
| `created_at` | `str` | Timestamp when the restroom was added |
| `directions` | `str` | Directions to find the restroom |
...
| `name` | `str` | Name of the location or establishment |
| `state` | `str` | State or province |
| `street` | `str` | Street address |
| `unisex` | `bool` | Whether the restroom is unisex/gender-neutral |
| `updated_at` | `str` | Timestamp when the restroom was last updated |
...
```
py/
├── refugerestrooms_sdk.py         -- Main SDK module
