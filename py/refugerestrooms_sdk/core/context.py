...
from refugerestrooms_sdk.core.helpers import get_ctx_prop, to_map
...
class RefugeRestroomsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = RefugeRestroomsControl()
        ...
        if isinstance(sp, RefugeRestroomsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, RefugeRestroomsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, RefugeRestroomsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return RefugeRestroomsOperation({})
    ...
    def make_error(self, code, msg):
        return RefugeRestroomsError(code, msg, self)
