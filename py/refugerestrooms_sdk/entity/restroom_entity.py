...
from refugerestrooms_sdk.refugerestrooms_types import (
    Restroom,
    RestroomListMatch,
)
...
class RestroomEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RestroomEntity(self._client, opts)
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Restroom]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Restroom().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
