...
from refugerestrooms_sdk.utility import register

# Load features
from refugerestrooms_sdk.feature.base_feature import RefugeRestroomsBaseFeature
from refugerestrooms_sdk.features import _has_feature, _make_feature
...
class RefugeRestroomsSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = RefugeRestroomsUtility()
    ...
    def get_utility(self):
        return RefugeRestroomsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("RefugeRestroomsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Restroom(self, data=None) -> "RestroomEntity":
        ...
        from refugerestrooms_sdk.entity.restroom_entity import RestroomEntity
