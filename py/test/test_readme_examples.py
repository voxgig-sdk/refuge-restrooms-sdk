# RefugeRestrooms SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RefugeRestroomsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RefugeRestroomsSDK(...) and RefugeRestroomsSDK.test(...) become
#      RefugeRestroomsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "refugerestrooms_sdk"
_SDK_CLASS = "RefugeRestroomsSDK"
