...
type RestroomEntity struct {
	name    string
	client  *core.RefugeRestroomsSDK
...
func NewRestroomEntity(client *core.RefugeRestroomsSDK, entopts map[string]any) *RestroomEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RestroomEntity) GetName() string { return e.name }
...
func (e *RestroomEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RestroomEntity) Deleted() bool {
	return e.deleted
}


func (e *RestroomEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRestroomEntity(e.client, opts)
}

func (e *RestroomEntity) Data(args ...any) any {
...
func (e *RestroomEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Restroom; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RestroomEntity) DataTyped(data ...Restroom) Restroom {
	if len(data) > 0 {
		return typedFrom[Restroom](e.Data(asMap(data[0])))
	}
	return typedFrom[Restroom](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Restroom (all fields
// optional at the wire level).
func (e *RestroomEntity) MatchTyped(match ...Restroom) Restroom {
	if len(match) > 0 {
		return typedFrom[Restroom](e.Match(asMap(match[0])))
	}
	return typedFrom[Restroom](e.Match())
}
...
func (e *RestroomEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RestroomEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RestroomEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RestroomListMatch and returns []Restroom. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RestroomEntity) ListTyped(reqmatch RestroomListMatch, ctrl map[string]any) ([]Restroom, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Restroom](res), nil
}



func (e *RestroomEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RestroomEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RestroomEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RestroomEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
