...
type RefugeRestroomsSDK struct {
	Mode     string
...
func (sdk *RefugeRestroomsSDK) OptionsMap() map[string]any {
...
func (sdk *RefugeRestroomsSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *RefugeRestroomsSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *RefugeRestroomsSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RefugeRestroomsSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *RefugeRestroomsSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *RefugeRestroomsSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("RefugeRestroomsSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *RefugeRestroomsSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RefugeRestroomsSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("RefugeRestroomsSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *RefugeRestroomsSDK {
	...
	sdk := NewRefugeRestroomsSDK(sdkopts)
	sdk.Mode = "test"
